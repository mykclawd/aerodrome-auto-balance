...
/// @dev Vendored from Uniswap v3-core / Velodrome SlipStream and adapted for solc 0.8.x by wrapping
///      intentional-overflow arithmetic in `unchecked` blocks. Logic is otherwise byte-identical.
library TickMath {
    error InvalidTick();
